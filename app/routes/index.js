...
//moved all from main.js so could route to app.js per lynda express tutorial**
var express = require('express');
var router = express.Router();


router.get('/', function(req, res){var dataFile = req.app.get('appData');
  res.send(`
    <h1>etch sdr site </h1>
